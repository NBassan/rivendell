  ...
  : QDialog(parent,"",true)
{
  ...
  station_broadcast_sec_label->setAlignment(Qt::AlignRight|Qt::AlignVCenter|Qt::TextShowMnemonic);
...
void EditStation::paintEvent(QPaintEvent *e)
{
  ...
  p->drawLine(10,343,sizeHint().width()-10,343);
  //p->lineTo(sizeHint().width()-10,401);
  p->drawLine(sizeHint().width()-10,343,sizeHint().width()-10,401);
  //p->lineTo(10,401);
  p->drawLine(sizeHint().width()-10,401,10,401);
  //p->lineTo(10,343);
