...
void RDTransportButton::drawOnCap()
{
  ...
  switch(button_type) {
	...
	//p.lineTo(width()/2-(3*edge)/10,height()/2-(3*edge)/10);
        p.drawLine(width()/2-(3*edge)/10,height()/2+(3*edge)/10,width()/2-(3*edge)/10,height()/2-(3*edge)/10);
	p.setPen(QColor(colorGroup().dark()));
	//p.lineTo(width()/2+(3*edge)/10,height()/2);
        p.drawLine(width()/2-(3*edge)/10,height()/2-(3*edge)/10,width()/2+(3*edge)/10,height()/2);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(3*edge)/10,height()/2+(3*edge)/10);
        p.drawLine(width()/2+(3*edge)/10,height()/2,width()/2-(3*edge)/10,height()/2+(3*edge)/10);
	break;
      case RDTransportButton::Stop:
	...
	//p.lineTo(width()/2-edge*3/10,height()/2-edge*3/10);
        p.drawLine(width()/2-edge*3/10,height()/2+edge*3/10,width()/2-edge*3/10,height()/2-edge*3/10);
	//p.lineTo(width()/2+edge*3/10,height()/2-edge*3/10);
        p.drawLine(width()/2-edge*3/10,height()/2-edge*3/10,width()/2+edge*3/10,height()/2-edge*3/10);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2+edge*3/10,height()/2+edge*3/10);
	...
	//p.lineTo(width()/2,height()/2);
        p.drawLine(width()/2-(3*edge)/10,height()/2-(3*edge)/10,width()/2,height()/2);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(3*edge)/10,height()/2+(3*edge)/10);
	p.drawLine(width()/2,height()/2,width()/2-(3*edge)/10,height()/2+(3*edge)/10);
	triangle.setPoint(0,width()/2,height()/2-(3*edge)/10);
	triangle.setPoint(1,width()/2+(3*edge)/10,height()/2);
	triangle.setPoint(2,width()/2,height()/2+(3*edge)/10);
	p.drawPolygon(triangle);
	...
	//p.lineTo(width()/2,height()/2-(3*edge)/10);
        p.drawLine(width()/2,height()/2+(3*edge)/10,width()/2,height()/2-(3*edge)/10);
	p.setPen(QColor(colorGroup().dark()));
	//p.lineTo(width()/2+(3*edge)/10,height()/2);
        p.drawLine(width()/2,height()/2-(3*edge)/10,width()/2+(3*edge)/10,height()/2);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2,height()/2+(3*edge)/10);
        p.drawLine(width()/2+(3*edge)/10,height()/2,width()/2,height()/2+(3*edge)/10);
	break;
      case RDTransportButton::Rewind:
	triangle.setPoint(0,width()/2+(3*edge)/10,height()/2-(3*edge)/10);
	triangle.setPoint(1,width()/2,height()/2);
	...
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(3*edge)/10,height()/2);
        p.drawLine(width()/2+(3*edge)/10,height()/2,width()/2-(3*edge)/10,height()/2);
	...
	p.drawLine(width()/2-(3*edge)/10,height()/2+edge/10+edge/5,width()/2-(3*edge)/10,height()/2+edge/10);
        //p.lineTo(width()/2+(3*edge)/10,height()/2+edge/10);
        p.drawLine(width()/2-(3*edge)/10,height()/2+edge/10,width()/2+(3*edge)/10,height()/2+edge/10);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2+(3*edge)/10,height()/2+edge/10+edge/5);
	p.drawLine(width()/2+(3*edge)/10,height()/2+edge/10,width()/2+(3*edge)/10,height()/2+edge/10+edge/5);
        //p.lineTo(width()/2-(3*edge)/10,height()/2+edge/10+edge/5);
        p.drawLine(width()/2+(3*edge)/10,height()/2+edge/10+edge/5,width()/2-(3*edge)/10,height()/2+edge/10+edge/5);
	break;
      case RDTransportButton::Pause:
	...
	//p.lineTo(width()/2-(3*edge)/10+(3*edge)/15,height()/2-(3*edge)/10);
        p.drawLine(width()/2-(3*edge)/10,height()/2-(3*edge)/10,width()/2-(3*edge)/10+(3*edge)/15,height()/2-(3*edge)/10);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(3*edge)/10+(3*edge)/15,height()/2+(3*edge)/10);
        p.drawLine(width()/2-(3*edge)/10+(3*edge)/15,height()/2-(3*edge)/10,width()/2-(3*edge)/10+(3*edge)/15,height()/2+(3*edge)/10);
	//p.lineTo(width()/2-(3*edge)/10,height()/2+(3*edge)/10);
        p.drawLine(width()/2-(3*edge)/10+(3*edge)/15,height()/2+(3*edge)/10,width()/2-(3*edge)/10,height()/2+(3*edge)/10);
	...
	//p.lineTo(width()/2+(3*edge)/30,height()/2-(3*edge)/10);
        p.drawLine(width()/2+(3*edge)/30,height()/2+(3*edge)/10,width()/2+(3*edge)/30,height()/2-(3*edge)/10);
	//p.lineTo(width()/2+(3*edge)/10,height()/2-(3*edge)/10);
        p.drawLine(width()/2+(3*edge)/30,height()/2-(3*edge)/10,width()/2+(3*edge)/10,height()/2-(3*edge)/10);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2+(3*edge)/10,height()/2+(3*edge)/10);
        p.drawLine(width()/2+(3*edge)/10,height()/2-(3*edge)/10,width()/2+(3*edge)/10,height()/2+(3*edge)/10);
	//p.lineTo(width()/2+(3*edge)/30,height()/2+(3*edge)/10);
        p.drawLine(width()/2+(3*edge)/10,height()/2+(3*edge)/10,width()/2+(3*edge)/30,height()/2+(3*edge)/10);
	break;
      case RDTransportButton::PlayFrom:
	p.fillRect(width()/2-(3*edge)/10,height()/2-(3*edge)/10,
	...
	p.drawLine(width()/2-(2*edge)/10+1,height()/2+(3*edge)/10,width()/2-(2*edge)/10+1,height()/2-(3*edge)/10);
        p.setPen(QColor(colorGroup().dark()));
	//p.lineTo(width()/2+(3*edge)/10+1,height()/2);
	p.drawLine(width()/2-(2*edge)/10+1,height()/2-(3*edge)/10,width()/2+(3*edge)/10+1,height()/2);
        p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(2*edge)/10+1,height()/2+(3*edge)/10);
	p.drawLine(width()/2+(3*edge)/10+1,height()/2,width()/2-(2*edge)/10+1,height()/2+(3*edge)/10);
	break;
      case RDTransportButton::PlayBetween:
	p.fillRect(width()/2-(3*edge)/10,height()/2-(3*edge)/10,
		   3,(3*edge)/5,QBrush(accent_color));
	...
	//p.lineTo(width()/2+(2*edge)/10+1,height()/2);
        p.drawLine(width()/2-(2*edge)/10+1,height()/2-(3*edge)/10,width()/2+(2*edge)/10+1,height()/2);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(2*edge)/10+1,height()/2+(3*edge)/10);
        p.drawLine(width()/2+(2*edge)/10+1,height()/2,width()/2-(2*edge)/10+1,height()/2+(3*edge)/10);
	break;
      case RDTransportButton::Loop:
	p.setPen(QColor(colorGroup().shadow()));
	//p.moveTo(width()/2-(2*edge)/10+1,height()/2+(edge)/4);
	//p.lineTo(width()/2+(edge)/10+1,height()/2-edge/10);
        p.drawLine(width()/2-(2*edge)/10+1,height()/2+(edge)/4,width()/2+(edge)/10+1,height()/2-edge/10);
	p.setPen(QColor(colorGroup().dark()));
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(2*edge)/10+1,height()/2+(edge)/4);
        p.drawLine(width()/2+(edge)/10+1,height()/2-edge/10,width()/2-(2*edge)/10+1,height()/2+(edge)/4);
	p.setPen(QColor(colorGroup().shadow()));
	...
	//p.lineTo(width()/2,(3*edge)/10);
        p.drawLine(width()/2-(3*edge)/10,height()-(3*edge)/10,width()/2,(3*edge)/10);
	p.setPen(QColor(colorGroup().dark()));
	//p.lineTo(width()/2+(3*edge)/10,height()-(3*edge)/10);
        p.drawLine(width()/2,(3*edge)/10,width()/2+(3*edge)/10,height()-(3*edge)/10);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(3*edge)/10,height()-(3*edge)/10);
        p.drawLine(width()/2+(3*edge)/10,height()-(3*edge)/10,width()/2-(3*edge)/10,height()-(3*edge)/10);
	break;
      case RDTransportButton::Down:
	triangle.setPoint(0,width()/2,height()-(3*edge)/10);
	triangle.setPoint(1,width()/2+(3*edge)/10,(3*edge)/10);
	...
	//p.lineTo(width()/2,height()-(3*edge)/10);
        p.drawLine(width()/2-(3*edge)/10,(3*edge)/10,width()/2,height()-(3*edge)/10);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2+(3*edge)/10,(3*edge)/10);
	p.drawLine(width()/2,height()-(3*edge)/10,width()/2+(3*edge)/10,(3*edge)/10);
        p.setPen(QColor(colorGroup().shadow()));
	//p.lineTo(width()/2-(3*edge)/10,(3*edge)/10);
	p.drawLine(width()/2+(3*edge)/10,(3*edge)/10,width()/2-(3*edge)/10,(3*edge)/10);
	break;
      case RDTransportButton::PlayTo:
	p.fillRect(width()/2+(3*edge)/10,height()/2-(3*edge)/10,
		   3,(3*edge)/5,QBrush(accent_color));
	...
	p.setPen(QColor(colorGroup().dark()));
	//p.lineTo(width()/2+(2*edge)/10+1,height()/2);
        p.drawLine(width()/2-(3*edge)/10,height()/2-(3*edge)/10,width()/2+(2*edge)/10+1,height()/2);
	p.setPen(QColor(colorGroup().light()));
	//p.lineTo(width()/2-(3*edge)/10,height()/2+(3*edge)/10);
        p.drawLine(width()/2+(2*edge)/10+1,height()/2,width()/2-(3*edge)/10,height()/2+(3*edge)/10);
	break;
  }  
  p.end();
}
